...
*/
        ...
        .pagination>li>span:hover {
            ...
            background-color: rgb(4, 112, 9) !important;
            border-color: solid 1px white !important;
        }

        .pagination>li>a {
            color: rgb(4, 112, 9) !important;
        }
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                {{-- <li class="nav-item d-none d-sm-inline-block">
                    <strong><a href="index3.html" class="nav-link text-primary">Home</a></strong>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <strong><a href="index3.html" class="nav-link text-primary">Contact</a></strong>
                </li> --}}
            </ul>
