                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nameabbr" id="nameabbr" class="form-control"
                                                    placeholder="Ex. UBPIA" value="{{ old('nameabbr') }}">
                                                @error('nameabbr')
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="namedesc" class="form-label"><span
                                                        class="text-red">*</span>&nbsp;Name
                                                    Description</label>
                                                <input type="text" name="namedesc" id="namedesc" class="form-control"
                                                    placeholder="Ex. UPPER PAGLAUM BAGUMBAYAN IRRIGATORS ASSOCIATION" value="{{ old('namedesc') }}">
                                                @error('namedesc')
                                                    <span class="text-red"><small>{{ $message }}</small></span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select " name="isreg_to" id="isreg_to">
                                                    ...
                                                    <option value="DOLE" {{ old('isreg_to') == "DOLE" ? "selected" : ""}}>DOLE</option>
                                                    <option value="SEC"  {{ old('isreg_to') == "SEC" ? "selected" : ""}}>SEC</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select " name="belongs_to_program"
                                                    ...
                                                    @foreach ($program as $item)
                                                        <option value="{{ $item->program_id }}"  {{ old('belongs_to_program') == $item->program_id ? "selected" : ""}}>{{ $item->program_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="citymun_id" class="form-label">
                                                    <span class="text-red">*</span>&nbsp;Region</label>
                                                <input type="text" name="citymun_id" id="citymun_id" class="form-control"
                                                    value="{{ $citymun }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select " name="barangay_id" id="barangay_id">
                                                    ...
                                                    @foreach ($barangay as $item)
                                                        <option value="{{ $item->id }}" {{ old('barangay_id') == $item->id ? "selected" : ""}}>{{ $item->brgyDesc }}
                                                        </option>
                                                    @endforeach
