                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nameabbr" id="nameabbr" class="form-control"
                                                    placeholder="Ex. UBPIA" value="{{ $association->nameabbr }}">
                                                @error('nameabbr')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select " name="isreg_to" id="isreg_to">
                                                    ...
                                                    <option value="DOLE"
                                                        {{ $association->isreg_to == 'DOLE' ? 'selected' : '' }}>DOLE
                                                    </option>
                                                    <option value="SEC"
                                                        {{ $association->isreg_to == 'SEC' ? 'selected' : '' }}>SEC</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="registration_no" id="registration_no"
                                                    ...
                                                    value="{{ $association->registration_no }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="dataregistered" id="dataregistered"
                                                    class="form-control" placeholder="Enter Registration No."
                                                    value="{{ $association->dataregistered }}" max="{{ date('Y-m-d') }}">
                                                ...
                                                <select class="form-select " name="belongs_to_program"
                                                    ...
                                                    @foreach ($program as $item)
                                                        <option value="{{ $item->program_id }}"
                                                            {{ $association->belongs_to_program == $item->program_id ? 'selected' : '' }}>
                                                            {{ $item->program_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-select " name="barangay_id" id="barangay_id">
                                                    ...
                                                    @foreach ($barangay as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $association->barangay_id == $item->id ? 'selected' : '' }}>
                                                            {{ $item->brgyDesc }}
                                                        </option>
                                                    @endforeach
